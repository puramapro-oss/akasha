    ...
    <section className="relative z-10 py-24 px-4">
      <div className="mx-auto max-w-6xl">
        <FadeIn className="text-center mb-16">
          ...
          <p className="mt-4 text-[var(--text-secondary)]">Tous ces outils sont inclus dans AKASHA AI.</p>
        </FadeIn>
        ...
        <FadeIn delay={0.3}>
          <div className="mt-12 glass rounded-2xl p-6">
            <div className="text-center mb-6 text-sm text-[var(--text-secondary)] font-medium">
              Ce que tu economies avec AKASHA AI
            </div>
...
function Superpowers() {
  const features = [
    ...
    },
    {
      ...
      name: 'Marketplace',
      color: 'var(--gold)',
      desc: 'Vends tes propres agents IA et workflows sur le Marketplace AKASHA. Monetise tes creations.',
    },
    {
          ...
          <div className="glass rounded-3xl overflow-hidden border border-white/[0.08]">
            ...
            <div className="flex items-center gap-2 border-b border-white/[0.06] bg-white/[0.02] px-5 py-3">
              ...
              <div className="mx-auto flex items-center gap-2 rounded-lg bg-white/[0.04] px-4 py-1.5 text-xs text-[var(--text-muted)]">
                <span>🔒</span>
                <span>akasha.purama.dev/dashboard</span>
              </div>
            </div>
        ...
        <FadeIn>
          <div className="glass rounded-3xl p-10 text-center border border-[var(--cyan)]/20">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-2xl font-bold text-[var(--text-primary)] mb-4">
              Rejoins les early adopters AKASHA AI
            </h2>
...
const faqs = [
  {
    q: "C'est quoi AKASHA AI ?",
    a: "AKASHA AI est un ecosysteme IA tout-en-un qui reunit 47+ outils dans une seule plateforme : chat multi-modeles, generation d'images et de videos, agents autonomes, automatisation de workflows, marketplace d'agents, et gamification. Tout ca pour un abonnement mensuel, sans changer d'app."
  },
  {
    q: "Combien ca coute ?",
  ...
  },
  {
    ...
    a: "La Marketplace AKASHA est un store d'agents IA et de workflows crees par la communaute. Tu peux acheter des agents prets-a-l'emploi ou vendre tes propres creations et gagner de l'argent. Accessible en plan Pro et superieur."
  },
  {
  ...
  },
  {
    ...
    a: "Oui ! Une API REST complete est disponible en plan Pro COMPLET et superieur. Tu peux integrer AKASHA dans tes propres apps : chat, generation d'images, agents, et plus. Documentation disponible sur /api."
  },
  {
    ...
    <footer className="relative z-10 border-t border-white/[0.06] py-16 px-4">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 border-t border-white/[0.06] pt-8 flex flex-col items-center gap-2 sm:flex-row sm:justify-between">
          <p className="text-xs text-[var(--text-muted)]">
            © 2026 AKASHA AI par SASU PURAMA — Frasne, France 🇫🇷
          </p>
          <p className="text-xs text-[var(--text-muted)]">
